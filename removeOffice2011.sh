...
# Description
#
#  The purpose of this script is to remove all files associated with Office for Mac 2011 to perform
#  a clean reinstall or upgrade.
#
####################################################################################################
# 
# HISTORY
#
#	-Created by Michael Sewell on September 22, 2015
#
####################################################################################################
