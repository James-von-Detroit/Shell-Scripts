...
# Description
#
#  The purpose of this script is to change the priority order of the specified SSID to 0(Top of list)
#
####################################################################################################
# 
# HISTORY
#
#	-Created by Michael Sewell on July 11, 2015
#
####################################################################################################

#Sets arguements for script
#Uses the JSS parameter options panel to set details
