...
# Description
#
#	The purpose of this script is to detect the installed version of Mozilla Firefox, query the  
#   Mozilla website for the current up-to-date version and update Firefox if needed.
#
####################################################################################################
# 
# HISTORY
#
#	-Created by Michael Sewell on October 4, 2015
#
####################################################################################################
